...
public class SlaService {
    ...
    public void calculateSlaDeadlines(Ticket ticket) {
        ...
        Duration firstResponseDuration = SlaConfig.FIRST_RESPONSE_SLA.getOrDefault(priority, SlaConfig.FIRST_RESPONSE_SLA.get("LOW"));
        Duration resolutionDuration = SlaConfig.RESOLUTION_SLA.getOrDefault(priority, SlaConfig.RESOLUTION_SLA.get("LOW"));
