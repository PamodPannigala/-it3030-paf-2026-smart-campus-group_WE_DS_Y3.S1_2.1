...
public class Resource {
    ...
    public Resource(Long id, String name, String type, Integer capacity, String location, String status,
                   String purchaseDate, String lastMaintenanceDate, String usageCount, LocalTime openTime,
                   LocalTime closeTime, boolean availableWeekends, String imageUrl, Integer purchaseYear) {
        this.id = id;
        this.name = name;
        this.type = type;
