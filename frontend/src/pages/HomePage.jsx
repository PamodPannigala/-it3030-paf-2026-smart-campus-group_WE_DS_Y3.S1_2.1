...
const Home = () => {
  ...
  const services = [
    ...
    },
    {
      title: "NOTIFICATIONS",
      description:
        "Campus-wide alerts, deadlines, and real-time announcements.",
      icon: "🔔",
      path: "/notifications",
    },
    {
    ...
    },
    {
      ...
      description:
        "Manage your profile, password, and communication preferences.",
      icon: "⚙️",
      path: "/settings",
    },
    {
    ...
    <div className="home-container">
      ...
      <section id="home" className="hero animate-on-scroll" ref={heroRef}>
        <div className="hero-content">
          ...
          <p>
            Join thousands of scholars and staff using our secure digital hub
            for facility management, rapid support, and seamless connectivity.
          </p>
          {!user ? (
      ...
      <section
        id="services"
        className="grid-section animate-on-scroll"
        ref={servicesRef}
        style={{
