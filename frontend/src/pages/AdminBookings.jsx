...
const AdminBookings = () => {
  ...
  const mostPopularResource = useMemo(() => {
    ...
    bookings.forEach((booking) => {
      if (booking.resourceName) {
        resourceCount[booking.resourceName] =
          (resourceCount[booking.resourceName] || 0) + 1;
      }
    });
  ...
  const LineChart = ({ categories = [], series = [], color = "#3b82f6" }) => (
    <Chart
      ...
      options={{
        ...
        title: {
          text: "Booking Trends (Last 7 Days)",
  ...
  const CheckedInDonutChart = ({ labels = [], series = [], colors = [] }) => (
    <Chart
      ...
      options={{
        ...
        dataLabels: { enabled: false },
        title: {
          text: "Check-in Status (Approved Bookings)",
          style: { fontSize: "14px", fontWeight: "500", color: "#374151" },
        },
        plotOptions: {
          pie: {
  ...
  const checkedInFilteredBookings =
    checkedInFilter === "ALL"
      ? dateFilteredBookings
      : dateFilteredBookings.filter((b) => {
          if (b.status !== "APPROVED")
            return checkedInFilter === "NOT_CHECKED_IN";
          if (checkedInFilter === "CHECKED_IN") return b.checkedIn === true;
          if (checkedInFilter === "NOT_CHECKED_IN")
            return b.checkedIn === false;
  ...
  return (
    <div className="container py-4">
        ...
        <div className="col-md-12">
          <div className="d-flex flex-wrap gap-3 align-items-center">
            ...
            <div className="btn-group flex-wrap gap-2">
              ...
              <button
                className={`btn ${filter === "CANCELLED" ? "btn-secondary" : "btn-outline-secondary"}`}
                style={{ borderRadius: "10px", fontWeight: "500" }}
      ...
      <div
        ...
        style={{ maxHeight: "450px", overflowY: "auto", borderRadius: "16px" }}
      >
        <table
          ...
          >
            <div className="card-body p-4">
              <CheckedInDonutChart
                ...
                series={[
                  checkedInStats.checkedIn,
                  checkedInStats.pending,
                  checkedInStats.missed,
                ]}
              ...
              <div className="modal-body">
                <div className="row">
                  ...
                  >
                    ...
                    <p>
                      <strong>Time:</strong> {viewModal.startTime} -{" "}
                      {viewModal.endTime}
                    </p>
                    <p>
                      <strong>Purpose:</strong> {viewModal.purpose}
                    </p>
                    {viewModal.expectedAttendees > 0 && (
                      <p>
                        <strong>Expected Attendees:</strong>{" "}
                        {viewModal.expectedAttendees}
                      </p>
                    )}
